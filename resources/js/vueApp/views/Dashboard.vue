                    ...
                    <div class="col-lg-5 col-xl-3">
                        <div class="card card-white grid-margin">
                            ...
                            <div class="card-body user-profile-card mb-3" >
                                <img  loading="lazy" :src="doctorAi" class="user-profile-image rounded-circle" alt="" style=" display: inline-block;" />
                                <span id="dr_info">
                                ...
                                <li class="timeline-item">
                                    <div class="card card-white grid-margin" style="height: 97%;">
                                        <div class="card-body" id="aiBot">
                                            <img   loading="lazy" v-show="showAi" src="../img/bot.gif" class="ml-5" height="200" alt="logo"
